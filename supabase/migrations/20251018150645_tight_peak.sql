/*
# Update AI Model Emission Factors to Realistic Values

1. Changes
  - Update emission factors for all AI models with realistic values
...
-- Update emission factors for all models with realistic values
...
-- Add Mistral Large if it doesn't exist
...
DO $$
BEGIN
  RAISE NOTICE 'Updated emission factors (realistic values):';
