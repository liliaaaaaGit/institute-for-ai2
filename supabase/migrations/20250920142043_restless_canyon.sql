/*
# Fix Public RPC Functions

1. Changes
  - Drop existing functions if they exist
  - Recreate with correct signatures for static client
...
-- Drop existing functions if they exist
DROP FUNCTION IF EXISTS create_session_public;
DROP FUNCTION IF EXISTS create_lead_public;
