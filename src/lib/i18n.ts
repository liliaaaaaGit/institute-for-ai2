...
export const translations = {
  de: {
    ...
    "form.calculateAndGetReport": "CO₂-Fußabdruck berechnen & E-Mail-Bericht erhalten",
  ...
  en: {
    ...
    "form.calculate": "Calculate CO₂ Footprint",
    "form.calculateAndGetReport": "Calculate CO₂ Footprint & Get Email Report",
